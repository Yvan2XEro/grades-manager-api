...
- La page frontend affiche un avertissement : *"Les surcharges de règles ne sont pas encore persistées"* — confirme que la personnalisation des règles est une UI sans effet réel.
...
*Fin de l'analyse. Ce document recense l'état réel du code sans y apporter de modifications.*
*Toutes les références à des lignes de code sont approximatives et basées sur l'exploration statique.*
