...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "instance-requests".
 */
export interface InstanceRequest {
	...
	subdomain: string;
	institutionType?:
		| ("university" | "school" | "institute" | "secondary" | "other")
		| null;
	country?: string | null;
	...
	/**
	 * Bearer token for seed YAML endpoints
	 */
...
export interface InstanceEvent {
	id: number;
	instance: number | InstanceRequest;
	eventType:
		| "submitted"
		| "approved"
		| "rejected"
...
export interface Invoice {
	 ...
	 */
	instance?: (number | null) | InstanceRequest;
	/**
...
export interface PayloadLockedDocument {
	...
	document?:
		...
		| ({
				...
				value: number | InstanceRequest;
		  } | null)
		| ({
				relationTo: "instance-events";
				value: number | InstanceEvent;
		  } | null)
		| ({
				relationTo: "invoices";
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "instance-requests_select".
 */
export interface InstanceRequestsSelect<T extends boolean = true> {
	orgName?: T;
	client?: T;
	subdomain?: T;
	institutionType?: T;
