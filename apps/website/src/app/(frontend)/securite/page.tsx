			...
			<section className="border-tk-border border-b">
				<div className="mx-auto max-w-[86rem] px-6 py-14 lg:px-10 lg:py-20">
					<p className="font-code text-[0.7rem] text-tk-eyebrow uppercase tracking-[0.16em]">
						{en ? "Security & governance" : "Sécurité & gouvernance"}
					</p>
							...
							<ul className="m-0 list-none p-0">
								{ROLES.map((r, i) => {
									...
									return (
										...
										>
											<span className="w-6 shrink-0 font-code text-[0.7rem] text-tk-muted tabular-nums">
												{String(i + 1).padStart(2, "0")}
											</span>
											<div className="min-w-0 flex-1 sm:flex sm:items-baseline sm:gap-6">
												<p className="font-bold font-display text-[1rem] text-tk-ink tracking-[-0.02em] sm:w-[13rem] sm:shrink-0">
													{c.name}
												</p>
												<p className="mt-1 max-w-[46ch] font-body text-[0.9rem] text-tk-ink-2 leading-[1.6] sm:mt-0">
													{c.scope}
												</p>
											</div>
										</li>
