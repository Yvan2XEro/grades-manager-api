...
export default async function IntegrationsPage() {
	...
	return (
		<main className="bg-tk-bg pt-[68px]">
			...
			<section className="border-tk-border border-b">
				<div className="mx-auto max-w-[86rem] px-6 py-14 lg:px-10 lg:py-20">
					<p className="font-code text-[0.7rem] text-tk-eyebrow uppercase tracking-[0.16em]">
						{en ? "Integrations & data" : "Intégrations & données"}
					</p>
			...
			<section
				id="imports"
				className="scroll-mt-[84px] border-tk-border border-b bg-tk-bg-deep"
			>
				<div className="mx-auto max-w-[86rem] px-6 py-14 lg:px-10 lg:py-20">
					<div className="grid grid-cols-1 gap-x-12 gap-y-10 lg:grid-cols-12">
						...
						<div className="min-w-0 lg:col-span-8">
									...
									return (
										...
										>
											...
											<div className="min-w-0">
												...
												<p className="mt-1 max-w-[56ch] font-body text-[0.875rem] text-tk-ink-2 leading-[1.6]">
													{c.detail}
												</p>
											</div>
										</li>
							...
							<p className="mt-8 max-w-[58ch] font-body text-[0.875rem] text-tk-muted leading-[1.65]">
								{en
			...
			<section
				id="api"
				className="scroll-mt-[84px] border-tk-border border-b bg-tk-bg"
			>
				<div className="mx-auto max-w-[86rem] px-6 py-14 lg:px-10 lg:py-20">
					<span className="font-code text-[0.7rem] text-tk-muted tabular-nums">
						02
					</span>
					<h2 className="mt-3 max-w-[24ch] font-display font-extrabold text-[clamp(1.6rem,1.1rem+1.9vw,2.4rem)] text-tk-title leading-[1.08] tracking-[-0.03em]">
						{en ? "What goes out — the API" : "Ce qui sort — l'API"}
					</h2>
					<p className="mt-4 max-w-[58ch] font-body text-[1rem] text-tk-ink-2 leading-relaxed">
						{en
								...
								{ENDPOINTS.map((e) => (
									<tr key={e.path} className="border-tk-border border-b">
										<td className="py-3.5 pr-4 align-top">
											<span
												className={`inline-block rounded px-2 py-0.5 font-code font-medium text-[0.7rem] ${
													e.method === "POST"
										...
										<td className="py-3.5 pr-4 align-top font-code text-[0.8125rem] text-tk-ink">
											{e.path}
										</td>
										<td className="py-3.5 align-top font-body text-[0.875rem] text-tk-ink-2 leading-[1.6]">
											{en ? e.en : e.fr}
										</td>
									</tr>
								))}
				...
				<div className="mx-auto max-w-[86rem] px-6 py-14 lg:px-10 lg:py-20">
					<div className="grid grid-cols-1 gap-x-12 gap-y-10 lg:grid-cols-12">
						<div className="lg:col-span-5">
							...
							<p className="mt-4 max-w-[42ch] font-body text-[0.95rem] text-tk-ink-2 leading-[1.7]">
								{en
						...
						<div className="lg:col-span-7">
							<div className="grid gap-5 sm:grid-cols-2">
								<div className="rounded-xl border border-tk-border bg-tk-surface p-6">
									<p className="font-code text-[0.8125rem] text-tk-primary-deep">
										deliberation.signed
									</p>
									<p className="mt-3 font-body text-[0.875rem] text-tk-ink-2 leading-[1.65]">
										{en
							...
							<p className="mt-6 max-w-[58ch] font-body text-[0.875rem] text-tk-muted leading-[1.65]">
								{en
				...
				<div className="relative mx-auto max-w-[86rem] px-6 py-16 lg:px-10 lg:py-24">
					<div className="grid grid-cols-1 gap-x-12 gap-y-8 lg:grid-cols-12">
						<div className="lg:col-span-5">
							...
							<h2 className="mt-4 max-w-[20ch] font-display font-extrabold text-[clamp(1.6rem,1.1rem+1.9vw,2.4rem)] leading-[1.08] tracking-[-0.03em]">
								{en
						...
						<div className="lg:col-span-7">
							<p className="max-w-[62ch] font-body text-[1rem] text-tk-on-dark-soft leading-[1.75]">
								{en
