...
function DialogContent({
	...
	// Radix Dialog sets pointer-events:none on body while open and is supposed to
	// remove it on close — but when onOpenChange(false) is called from a mutation
	// onSuccess, the cleanup races with the animation and sometimes never fires.
	// Cleaning up on unmount is reliable because Radix removes the content node
	// from the DOM only after the close animation finishes.
	React.useEffect(() => {
		return () => {
