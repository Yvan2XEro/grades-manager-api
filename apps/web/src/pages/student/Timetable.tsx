	...
	return (
		<div className="p-6">
			<div className="mb-6">
				...
				<p className="text-muted-foreground text-sm">Vos cours de la semaine</p>
			</div>
			...
			{!isPending && sessions.length === 0 ? (
				<Empty>
					...
					<EmptyTitle>Aucun cours planifié</EmptyTitle>
					<EmptyDescription>
						Vos cours hebdomadaires apparaîtront ici une fois programmés.
					</EmptyDescription>
				</Empty>
			) : (
