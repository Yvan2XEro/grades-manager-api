...
const sampleAcademics: AcademicsSeed = {
	...
	classes: [
		...
		{
			code: "INF25-BTS2A",
			name: "BTS Sciences Infirmières 2ème année - Groupe A",
			programCode: "BTS-INFIRMIER",
			programOptionCode: "GENERAL",
			academicYearCode: "AY-2025",
			studyCycleCode: "BTS-SANTE",
		...
		{
			code: "COMPT25-BTS2A",
			name: "BTS Comptabilité 2ème année - Groupe A",
			programCode: "BTS-COMPTA",
			programOptionCode: "GENERAL",
			academicYearCode: "AY-2025",
			studyCycleCode: "BTS-COMMERCE",
			cycleLevelCode: "BTS2-COM",
			semesterCode: "S1",
		},
		{
			code: "INF26-BTS1A",
			name: "BTS Sciences Infirmières 1ère année 2026 - Groupe A",
			programCode: "BTS-INFIRMIER",
			programOptionCode: "GENERAL",
		...
		{
			code: "INF26-BTS2A",
			name: "BTS Sciences Infirmières 2ème année 2026 - Groupe A",
			programCode: "BTS-INFIRMIER",
			programOptionCode: "GENERAL",
			academicYearCode: "AY-2026",
			studyCycleCode: "BTS-SANTE",
		...
		{
			code: "COMPT26-BTS1A",
			name: "BTS Comptabilité 1ère année 2026 - Groupe A",
			programCode: "BTS-COMPTA",
			programOptionCode: "GENERAL",
			academicYearCode: "AY-2026",
			studyCycleCode: "BTS-COMMERCE",
		...
		{
			code: "COMPT26-BTS2A",
			name: "BTS Comptabilité 2ème année 2026 - Groupe A",
			programCode: "BTS-COMPTA",
			programOptionCode: "GENERAL",
			academicYearCode: "AY-2026",
			studyCycleCode: "BTS-COMMERCE",
	...
	classCourses: [
		...
		// Cours pour la classe BTS Infirmier 2A (AY-2025)
		{
			code: "CC-ANAT101-INF2A",
			classCode: "INF25-BTS2A",
			classAcademicYearCode: "AY-2025",
			courseCode: "ANAT101",
			teacherCode: "TEACH-DR-MBALLA",
			semesterCode: "S1",
		...
		// Cours pour la classe BTS Comptabilité 2A (AY-2025)
		{
			code: "CC-COMPT101-COMPT2A",
			classCode: "COMPT25-BTS2A",
			classAcademicYearCode: "AY-2025",
			courseCode: "COMPT101",
			teacherCode: "TEACH-KOMBO",
			semesterCode: "S1",
		...
		// Cours pour la classe BTS Infirmier 1A (AY-2026)
		{
			code: "CC-ANAT101-INF1A-26",
			classCode: "INF26-BTS1A",
			classAcademicYearCode: "AY-2026",
			courseCode: "ANAT101",
			teacherCode: "TEACH-DR-MBALLA",
			semesterCode: "S1",
		},
		{
			code: "CC-PHYS101-INF1A-26",
			classCode: "INF26-BTS1A",
			classAcademicYearCode: "AY-2026",
			courseCode: "PHYS101",
			teacherCode: "TEACH-DR-NGUEMA",
		...
		// Cours pour la classe BTS Infirmier 2A (AY-2026)
		{
			code: "CC-ANAT101-INF2A-26",
			classCode: "INF26-BTS2A",
			classAcademicYearCode: "AY-2026",
			courseCode: "ANAT101",
			teacherCode: "TEACH-DR-MBALLA",
			semesterCode: "S1",
		...
		// Cours pour la classe BTS Comptabilité 1A (AY-2026)
		{
			code: "CC-COMPT101-COMPT1A-26",
			classCode: "COMPT26-BTS1A",
			classAcademicYearCode: "AY-2026",
			courseCode: "COMPT101",
			teacherCode: "TEACH-KOMBO",
			semesterCode: "S1",
		...
		// Cours pour la classe BTS Comptabilité 2A (AY-2026)
		{
			code: "CC-COMPT101-COMPT2A-26",
			classCode: "COMPT26-BTS2A",
			classAcademicYearCode: "AY-2026",
			courseCode: "COMPT101",
			teacherCode: "TEACH-KOMBO",
			semesterCode: "S1",
...
const sampleUsers: UsersSeed = {
	...
	domainUsers: [
		...
		{
			code: "STUDENT-ATEBA",
			authUserCode: "STUDENT-ATEBA",
			firstName: "Marie",
			lastName: "Ateba",
			primaryEmail: "ateba.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-FOUDA",
			authUserCode: "STUDENT-FOUDA",
			firstName: "Paul",
			lastName: "Fouda",
			primaryEmail: "fouda.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-NKOA",
			authUserCode: "STUDENT-NKOA",
			firstName: "Claire",
			lastName: "Nkoa",
			primaryEmail: "nkoa.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-TENE",
			authUserCode: "STUDENT-TENE",
			firstName: "Joseph",
			lastName: "Tene",
			primaryEmail: "tene.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-MVONDO",
			authUserCode: "STUDENT-MVONDO",
			firstName: "Agnes",
			lastName: "Mvondo",
			primaryEmail: "mvondo.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-BEKONO",
			authUserCode: "STUDENT-BEKONO",
			firstName: "Bruno",
			lastName: "Bekono",
			primaryEmail: "bekono.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-OLAMA",
			authUserCode: "STUDENT-OLAMA",
			firstName: "Suzanne",
			lastName: "Olama",
			primaryEmail: "olama.student@inses.cm",
			status: "active",
		},
		{
			code: "STUDENT-KANA",
			authUserCode: "STUDENT-KANA",
			firstName: "Desire",
			lastName: "Kana",
			primaryEmail: "kana.student@inses.cm",
			status: "active",
		},
	],
	students: [
		...
		{
			code: "STUDENT-ATEBA",
			domainUserCode: "STUDENT-ATEBA",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0003",
		},
		{
			code: "STUDENT-FOUDA",
			domainUserCode: "STUDENT-FOUDA",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0004",
		},
		{
			code: "STUDENT-NKOA",
			domainUserCode: "STUDENT-NKOA",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0005",
		},
		{
			code: "STUDENT-TENE",
			domainUserCode: "STUDENT-TENE",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0006",
		},
		{
			code: "STUDENT-MVONDO",
			domainUserCode: "STUDENT-MVONDO",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0007",
		},
		{
			code: "STUDENT-BEKONO",
			domainUserCode: "STUDENT-BEKONO",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0008",
		},
		{
			code: "STUDENT-OLAMA",
			domainUserCode: "STUDENT-OLAMA",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
			registrationNumber: "INSES25-0009",
		},
		{
			code: "STUDENT-KANA",
			domainUserCode: "STUDENT-KANA",
			classCode: "INF25-BTS1A",
			classAcademicYearCode: "AY-2025",
	...
	studentCourseEnrollments: [
		...
		{
			studentCode: "STUDENT-ATEBA",
			classCourseCode: "CC-PHYS101-INF1A",
			courseCode: "PHYS101",
			sourceClassCode: "INF25-BTS1A",
			sourceClassAcademicYearCode: "AY-2025",
			academicYearCode: "AY-2025",
		...
		{
			studentCode: "STUDENT-ATEBA",
			classCourseCode: "CC-SOIN101-INF1A",
			courseCode: "SOIN101",
			sourceClassCode: "INF25-BTS1A",
			sourceClassAcademicYearCode: "AY-2025",
			academicYearCode: "AY-2025",
