-- Extend export_templates with theme_defaults + system flag + description
...
-- Stack per-program theme overrides on top of template defaults
ALTER TABLE "program_export_templates" ADD COLUMN "theme_overrides" jsonb;--> statement-breakpoint

-- Per-class assignment of an export template (overrides program default)
