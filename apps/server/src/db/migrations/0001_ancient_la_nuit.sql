...
ALTER TABLE "domain_users" DROP CONSTRAINT "uq_domain_users_auth";--> statement-breakpoint
ALTER TABLE "domain_users" DROP CONSTRAINT "uq_domain_users_email";--> statement-breakpoint
ALTER TABLE "domain_users" DROP CONSTRAINT "domain_users_auth_user_id_user_id_fk";
--> statement-breakpoint
...
ALTER TABLE "domain_users" DROP COLUMN "auth_user_id";--> statement-breakpoint
