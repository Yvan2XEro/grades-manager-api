import type { ExportConfig } from "../modules/exports/template-helper";
...
export const defaultExportConfig: ExportConfig = {
	institution: {
		...
		faculty_name_fr: "FACULTÉ DE MÉDECINE ET DES SCIENCES PHARMACEUTIQUES",
		faculty_name_en: "FACULTY OF MEDICINE AND PHARMACEUTICAL SCIENCES",
	},
	grading: {
		appreciations: [
